...
df_output_dict = write_model_info_and_plots(models, X_dict, df_int, cols_to_fit, "models/RANSAC", interactive_plot=False)

models["model_df_0.9_1.1"].clusters_[0]
n_unassigned = int(np.sum(models["model_df_1.1_inf"].labels_ == -1))
print(f"Unassigned values: {n_unassigned}")
